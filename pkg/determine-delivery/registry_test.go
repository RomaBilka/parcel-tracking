...
func TestDetermine(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "USPS start 94001 & 17 digits", trackId: "9400100000000000000000", carrier: uspsCarrier},
		{name: "USPS start 94073 & 17 digits", trackId: "9407300000000000000000", carrier: uspsCarrier},
		{name: "USPS start 93033 & 17 digits", trackId: "9303300000000000000000", carrier: uspsCarrier},
		{name: "USPS start 92088 & 17 digits", trackId: "9208800000000000000000", carrier: uspsCarrier},
		{name: "USPS start 92021 & 17 digits", trackId: "9202100000000000000000", carrier: uspsCarrier},
		{name: "USPS start 92701 & 17 digits", trackId: "9270100000000000000000", carrier: uspsCarrier},
		{name: "USPS start EC & 9 digits end US", trackId: "EC000000000US", carrier: uspsCarrier},
		{name: "USPS start EA & 9 digits end US", trackId: "EA000000000US", carrier: uspsCarrier},
		{name: "USPS start CP & 9 digits end US", trackId: "CP000000000US", carrier: uspsCarrier},
		{name: "USPS start 82 & 8 digits", trackId: "8200000000", carrier: uspsCarrier},
