...
type TrackingDocumentResponse struct {
	...
	DocumentWeight                       any    `json:"DocumentWeight,omitempty"`             //"3"
	FactualWeight                        string `json:"FactualWeight"`                        //"3"
	VolumeWeight                         string `json:"VolumeWeight"`                         //"0.1",
	CheckWeight                          any    `json:"CheckWeight,omitempty"`                //""
	DocumentCost                         string `json:"DocumentCost"`                         //"51"
	SumBeforeCheckWeight                 any    `json:"SumBeforeCheckWeight,omitempty"`       //""
	...
	WarehouseRecipientNumber             any    `json:"WarehouseRecipientNumber,omitempty"`   //"101"
